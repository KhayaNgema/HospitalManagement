...
{
    public class RegisterSupplierAdministratorModel : PageModel
    {
        ...
        public RegisterSupplierAdministratorModel(
        ...
        public async Task OnGetAsync(string supplierId, string returnUrl = null)
        {
            ReturnUrl = returnUrl;
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            try
            {
                ...
                var decryptedSupplierId = _encryptionService.DecryptToInt(Input.SupplierId);

                var user = await _userManager.GetUserAsync(User);

                var doctor = new SupplierAdministrator
                {
                ...
                if (result.Succeeded)
                {
                    _logger.LogInformation("supplier admin a new account with password.");

                    await _userManager.AddToRoleAsync(doctor, "Supplier Administrator");
                    ...
                    accountCreationEmailBody += $"Welcome to MediCare platform!<br><br>";
                    accountCreationEmailBody += $"You have been successfully added as Medicare Supplier Administrator. Below are your login credentials:<br><br>";
                    ...
                    var encryptedSupplierId = _encryptionService.Encrypt(Input.SupplierId);

                    TempData["Message"] = $"{doctor.FirstName} {doctor.LastName}  has been successfully added as your new supplier administrator";
                    return RedirectToAction("SupplierAdministrators", "Suppliers", new { supplierId = encryptedSupplierId });
                }
