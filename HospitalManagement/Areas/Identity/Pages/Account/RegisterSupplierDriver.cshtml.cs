...
{
    public class RegisterSupplierDriverModel : PageModel
    {
        ...
        public RegisterSupplierDriverModel(
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            try
            {
                ...
                if (result.Succeeded)
                {
                    _logger.LogInformation("driver a new account with password.");

                    await _userManager.AddToRoleAsync(doctor, "Supplier Driver");
                    ...
                    accountCreationEmailBody += $"You have been successfully added as Medicare Supplier Driver. Below are your login credentials:<br><br>";
                    ...
                    var encryptedSupplierId = _encryptionService.Encrypt(supplierId);

                    TempData["Message"] = $"{doctor.FirstName} {doctor.LastName}  has been successfully added as your new supplier driver";
                    return RedirectToAction("SupplierDrivers", "Suppliers", new { supplierId = encryptedSupplierId });
                }
